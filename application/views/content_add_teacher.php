                        ...
                        <div class="col-md-10">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Registerasi teacher</h4>
                                </div>
                                <div class="card-body">
                                    
                                    <form role="form" method="POST" action="<?php echo base_url()."index.php/admin/insert_teacher"; ?>">
                                        <div class="row">
                                            <div class="col-md-12">
                                         ...
                                         <div class="row">
                                            <div class="col-md-6 pr-1">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="nip" class="form-control" placeholder="" value="">
                                                </div>
                                            </div>
